...
//            Log
    ...
    public void getUserInfo() {
        ...
        InternetConnectionUtils.isInternetAvailable(RatingActivity.this, new InternetAvailableCallback() {
            ...
            public void onInternetAvailable(boolean isAvailable) {
                if (isAvailable) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    progressDialog.hide();
                                    AppErrorsManager.showErrorDialog(RatingActivity.this, e.getMessage());
                                }
                            });
                        }
                        if (!response.isSuccessful()) {
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    progressDialog.hide();
                                    AppErrorsManager.showErrorDialog(RatingActivity.this, response + "");
                                }
                            });
                        }
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            progressDialog.hide();
                            AppErrorsManager.showErrorDialog(RatingActivity.this, getString(R.string.error_network));
                        }
                    });
                }
            }
        ...
        InternetConnectionUtils.isInternetAvailable(this, new InternetAvailableCallback() {
            ...
            public void onInternetAvailable(boolean isAvailable) {
                if (isAvailable) {
                    ...
                    okhttp3.Request request = new okhttp3.Request.Builder().url(FontManager.URL
                            + "rating_partner").post(requestBody).build();
                    final okhttp3.Response response;
                    try {
                        response = client.newCall(request).execute();
                        String response_data = Objects.requireNonNull(response.body()).string();
