...
public class TankAdapter extends RecyclerView.Adapter<TankAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tankType, tankNumber, rentValue;
    ...
    public TankAdapter(Context context, List<Tanks> tanksList, OnItemClickListener listener) {
