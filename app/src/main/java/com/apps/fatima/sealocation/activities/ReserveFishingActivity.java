...
public class ReserveFishingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void reserveFishingInfo(final RequestBody requestBody) {
        handler.post(new Runnable() {
            @Override
            public void run() {
                progressDialog = new ProgressDialog(ReserveFishingActivity.this);
            ...
            public void onInternetAvailable(boolean isAvailable) {
                if (isAvailable) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (jsonObject.has("error")) {
                                ...
                                handler.post(new Runnable() {
                                    ...
                                    public void run() {
                                        progressDialog.hide();
                                        AppErrorsManager.showSuccessDialog(ReserveFishingActivity.this, " " +
                            ...
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    progressDialog.hide();
                                    AppErrorsManager.showErrorDialog(ReserveFishingActivity.this, e.getMessage());
                                }
                            });
                        }
                        if (!response.isSuccessful()) {
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    progressDialog.hide();
                                    AppErrorsManager.showErrorDialog(ReserveFishingActivity.this, response + "");
                                }
                            });
                        }
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            progressDialog.hide();
                            AppErrorsManager.showErrorDialog(ReserveFishingActivity.this, getString(R.string.error_network));
                        }
                    });
                }
            }
