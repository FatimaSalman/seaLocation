...
public class BigSelectMapActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
...
//            mMap.addMarker(new MarkerOptions().position(locationMark).icon(BitmapDescriptorFactory.fromResource(R.drawable.bluedot)));
    ...
    private void addMarker(final LatLng latLng) {
        ...
        mMarker = mMap.addMarker(new MarkerOptions().position(latLng).title(getString(R.string.i_am_here)).snippet(latitude + " , " + longitude)
